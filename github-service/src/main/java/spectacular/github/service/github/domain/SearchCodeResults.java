...
public class SearchCodeResults {
    ...
    public SearchCodeResults(@JsonProperty("total_count") int totalCount, @JsonProperty("items") List<SearchCodeResultItem> items, @JsonProperty("incomplete_results") boolean isIncompleteResults) {
