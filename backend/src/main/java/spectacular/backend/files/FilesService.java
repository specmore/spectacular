...
public class FilesService {
  ...
  public String getFileContent(CatalogueId catalogueId, String interfaceName, String ref, String username)
      throws UnsupportedEncodingException {
    //var isInCatalogue = catalogueService.isSpecFileInCatalogue(catalogueId, interfaceName, username);
    return null;
  }
}
