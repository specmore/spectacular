...
public class InstanceConfigManifest {
  ...
  public InstanceConfigManifest(@JsonProperty("name") String name,
                                @JsonProperty("catalogues") List<Catalogue> catalogues) {
    this.name = name;
    this.catalogues = catalogues;
  }

  public static InstanceConfigManifest parse(String instanceConfigFile)
