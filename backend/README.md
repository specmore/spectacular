...
- `JWT_SHARED_SECRET` - The secret key shared with the [User Authentication Service](../docs/architecture.md#user-authentication-service) for validating JWTs sent in each API request from the user's client agent.
